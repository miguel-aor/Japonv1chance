...
Japan Rail Pass: ${jrPassType}
  ...
  const generateCompletePDF = () => {
    ...
    doc.setFontSize(12);
    const totalCost = calculateTotalCost();
    doc.text(`Presupuesto Total: ¥${totalCost.toLocaleString()} (≈ $${(totalCost * YEN_TO_USD).toFixed(2)} USD)`, 20, yPos);
    ...
    cities.forEach(city => {
      ...
      yPos += 8;
      doc.setFontSize(12);
      doc.text(`Fechas: ${city.startDate.toLocaleDateString()} - ${city.endDate.toLocaleDateString()}`, 30, yPos);
      ...
      if (cityAttractions.length > 0) {
        ...
        cityAttractions.forEach(attr => {
          ...
          doc.text(`• ${attr.name} - ¥${attr.price} - ${attr.timeNeeded}`, 40, yPos);
        });
      }
    });
    ...
    usefulPhrases.forEach(phrase => {
      ...
      doc.setFontSize(12);
      doc.text(`${phrase.phrase}: ${phrase.japanese} (${phrase.pronunciation})`, 30, yPos);
    });
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
            ...
            <div className="col-span-1 md:col-span-3 flex justify-center md:justify-end">
              <div className="bg-white text-red-600 rounded-full px-3 py-1 md:px-4 md:py-2 text-sm md:text-base font-semibold">
                ¥1 = ${YEN_TO_USD.toFixed(6)} USD = ${(YEN_TO_USD * USD_TO_MXN).toFixed(2)} MXN
              </div>
            </div>
                      ...
                      <div className="bg-white p-4">
                        <div className="flex flex-col md:flex-row md:justify-between md:items-center">
                          ...
                          <div className="text-xs md:text-sm text-gray-600 mt-1 md:mt-0">
                            ...
                            {city.endDate.toLocaleDateString("es-ES")} ({city.days} días)
                          </div>
                        </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <div className="mb-6">
                    ...
                    >
                      <option value="7 días">
                        7 días (¥33,610/persona)
                      </option>
                      <option value="14 días">
                        14 días (¥52,960/persona)
                      </option>
                      <option value="21 días">
                        21 días (¥66,200/persona)
                      </option>
                    </select>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg mt-8">
                    ...
                    <div className="mt-4 text-sm text-gray-600">
                      <p>
                        Costo por persona:{" "}
                        {formatYen(calculateTotalCost() / 5)}
                      </p>
                      <p>
                        Costo por día:{" "}
                        {formatYen(calculateTotalCost() / 26)}
                      </p>
                    </div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div className="mt-6 p-3 bg-blue-50 text-blue-800 rounded-lg">
                      ...
                      <p className="mt-2 text-sm">
                        <strong>Importante:</strong> El JR Pass debe
                        comprarse antes de llegar a Japón.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="mt-6 space-y-4">
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      ...
                      <p className="text-sm text-gray-700">
                        ...
                        transporte público dentro de las ciudades. Cuesta
                        ¥2,000 (con ¥1,500 de saldo y ¥500 de depósito
                        reembolsable).
                      </p>
                    </div>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      ...
                      <p className="text-sm text-gray-700">
                        Si compras el JR Pass, recomendamos activarlo el día
                        que viajes de Tokio a Kioto (10 de julio) para
                        maximizar su uso en los días de viajes largos.
                      </p>
                    </div>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      ...
                      <ul className="list-disc pl-5 mt-2 text-sm text-gray-700">
                        <li>
                          Narita Express (N'EX): ¥3,070 por persona, 60
                          minutos hasta la estación de Tokio
                        </li>
                        <li>
                ...
                <div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <p className="mb-4">
                      ...
                      verano en Japón. El clima es generalmente cálido y
                      húmedo.
                    </p>
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <ul className="list-disc pl-5 text-sm text-gray-700">
                          ...
                          <li>
                            Precipitación: Frecuente, lluvias repentinas
                          </li>
                        </ul>
                      </div>
                      ...
                      <div>
                        ...
                        <ul className="list-disc pl-5 text-sm text-gray-700">
                          ...
                          <li>
                            Precipitación: Alta, posibles lluvias fuertes
                          </li>
                        </ul>
                      </div>
                      ...
                      <div>
                        ...
                        <ul className="list-disc pl-5 text-sm text-gray-700">
                          ...
                          <li>
                            Aplicación de clima para estar al tanto de
                            lluvias
                          </li>
                        </ul>
                      </div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg space-y-4">
                    <div>
                      ...
                      <p className="text-sm text-gray-700">
                        ...
                        escribe deseos en tiras de papel y las cuelga en
                        árboles de bambú.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-700">
                        Todo el mes de julio, con desfiles principales el 17
                        y 24. Uno de los festivales más famosos de Japón,
                        con carrozas enormes y eventos durante todo el mes.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-700">
                        13-16 de julio en el Santuario Yasukuni. Festival
                        con 30,000 linternas iluminando el camino y puestos
                        de comida.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-700">
                        24-25 de julio. Uno de los tres grandes festivales
                        de Japón, con desfiles terrestres y fluviales, y
                        fuegos artificiales.
                      </p>
                    </div>
                  </div>
              ...
              <div className="mt-8">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p className="mt-4 text-sm text-gray-600">
                    <span className="text-red-600">*</span> Elementos
                    esenciales
                  </p>
                </div>
              </div>
